"""Strict carriers and deterministic CBOR for P1-A10."""
...
STANDARD = "EIGIIB-P1-A10-1.0"
PROFILE = "delegated-threshold-authorization-revocation-v1"
POLICY_TYPE = "application/vnd.eigiib.release-authorization-policy+json"
APPROVAL_TYPE = "application/vnd.eigiib.release-approval+json"
REVOCATION_TYPE = "application/vnd.eigiib.delegate-revocation+json"
ROUTES = [
