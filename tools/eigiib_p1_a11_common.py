"""Strict carriers and deterministic CBOR for P1-A11."""
...
STANDARD = "EIGIIB-P1-A11-1.0"
PROFILE = "trusted-timestamp-window-rollback-expiry-v1"
POLICY_TYPE = "application/vnd.eigiib.trusted-time-policy+json"
OBSERVATION_TYPE = "application/vnd.eigiib.trusted-time-observation+json"
ROUTES = [
