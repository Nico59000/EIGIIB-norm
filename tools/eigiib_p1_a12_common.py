"""Strict carriers and deterministic CBOR for P1-A12."""
...
STANDARD = "EIGIIB-P1-A12-1.0"
PROFILE = "registered-transparency-witness-consistency-equivocation-recovery-v1"
REGISTRATION_TYPE = "application/vnd.eigiib.transparency-registration+json"
CHECKPOINT_TYPE = "application/vnd.eigiib.transparency-checkpoint+json"
WITNESS_TYPE = "application/vnd.eigiib.transparency-witness-statement+json"
SUCCESSION_TYPE = "application/vnd.eigiib.transparency-succession+json"
ROUTES = [
